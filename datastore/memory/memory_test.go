...
func TestStore_UserWorkflow(t *testing.T) {
	tests := []struct {
		...
		{"valid", datastore.User{Username: "jsmith", Name: "Joseph Smith", Role: 200}, 2, "jsmith", false, false},
		{"invalid-find", datastore.User{Username: "jsmith", Name: "Joseph Smith", Role: 200}, 2, "not-exists", false, true},
	}
